    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg w-full max-w-[420px] mx-4 shadow-xl shadow-black/5 border border-[#e5e7eb]">
        <div className="px-6 pt-5 pb-4">
          <h2 className="text-[15px] font-semibold text-[#111827]">{t('Delete Organization')}</h2>
          <p className="text-[13px] text-[#6b7280] mt-1.5 leading-relaxed">
            {t('Are you sure you want to delete')}{' '}
            <span className="font-semibold text-[#111827]">{orgName}</span>?{' '}
            {t('All brands, members, and data inside will be permanently removed. This cannot be undone.')}
          </p>
        </div>
